...
3. **Kommentare und Feedback:** Karten können einen Kommentarbereich enthalten, in dem Lehrkräfte/Professoren und Mitschüler Feedback geben oder Fragen stellen können.
4. **Sterne**: Lehrkräfte/Professoren können eine Karte je nach Kreativität mit bis zu 5 Sternen bewerten.
5. **Reaktionen**: Schüler und Lehrkräfte/Professoren können mithilfe von Emojis auf Karten reagieren.
...
1. <mark style="background-color:blue;">**Bereich öffnen:**</mark> Navigieren Sie zu dem Bereich, in dem Sie eine Karte hinzufügen möchten. Klicken Sie auf die Schaltfläche **Karte hinzufügen**.

<figure><img src="../.gitbook/assets/Untitled design (10).png" alt=""><figcaption></figcaption></figure>

2. <mark style="background-color:blue;">**Neue Karte erstellen:**</mark> Klicken Sie auf die Schaltfläche **Karte hinzufügen**.

<figure><img src="../.gitbook/assets/Screenshot 2024-09-05 180911.png" alt=""><figcaption></figcaption></figure>

3. <mark style="background-color:blue;">**Kartendetails eingeben:**</mark>

* **Name:** Geben Sie einen prägnanten Titel für die Karte ein.
* **Beschreibung:** Geben Sie eine detaillierte Beschreibung des Inhalts oder der Arbeit ein, die auf der Karte präsentiert wird.
* **Anhänge:** Laden Sie relevante Dateien, Audiodateien, Screenshots, Videos oder Links hoch.

4. <mark style="background-color:blue;">**Posten:**</mark> Klicken Sie auf **Veröffentlichen**, um die Karte zu erstellen.
...
* **Karte zur persönlichen Reflexion**: Studierende reflektieren ein Gruppenprojekt, indem sie eine Karte mit dem Titel „Reflexion zur Gruppendynamik“ erstellen, die ihre Erfahrungen beschreibt und einen Screenshot der Abschlusspräsentation enthält.
